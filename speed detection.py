...
import cv2
import time
cap = cv2.VideoCapture('4K camera example for Traffic Monitoring (Road).mp4')  #Path to footage
...
while True:
    ...
    cv2.line(img, (coord[0][0],coord[0][1]),(coord[1][0],coord[1][1]),(0,0,255),2)   #Firsta horizontal line
